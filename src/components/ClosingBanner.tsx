  ...
  return (
    <section className="bg-[#ECEDEC] px-5 py-16 sm:px-8 sm:py-20 lg:px-10 lg:py-28">
      <div className="animate-fade-up mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <Link
          to="/shop"
          className="font-inter mt-8 flex h-14 w-full max-w-[240px] items-center justify-center gap-2 rounded-md bg-black font-medium text-white transition-opacity hover:opacity-90 sm:h-16 lg:h-[72px] lg:max-w-[280px]"
