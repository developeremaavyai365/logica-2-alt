    ...
    >
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="font-inter mt-4 flex h-12 w-full items-center justify-center gap-2 rounded-md bg-black font-medium text-white transition-opacity hover:opacity-90"
