...
export default function ProductGallery({ images, alt, productId }: { images: string[]; alt: string; productId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="w-full rounded-2xl bg-[#ECEDEC] aspect-[4/3] flex items-center justify-center overflow-hidden">
        <motion.img
          key={current}
        ...
        <div className="flex gap-2.5 overflow-x-auto">
          {images.map((src, i) => (
            <button
              ...
              className={`relative shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-lg overflow-hidden bg-[#ECEDEC] border-2 transition-colors ${
