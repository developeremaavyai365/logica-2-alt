      ...
      <div className="mx-auto max-w-md">
        ...
        >
          ...
          <button
            ...
            className="btn-liquid font-inter flex h-14 w-full items-center justify-center rounded-md border-2 border-[#000000] font-medium text-[#000000] transition-colors disabled:opacity-60"
